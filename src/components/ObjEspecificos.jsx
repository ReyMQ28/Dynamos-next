...
function ObjEspecificos() {
  ...
  return (
    // principal
    <div className="flex flex-col lg:w-full lg:h-full md:w-full md:h-full justify-center imagen-about lg:pt-6 lg:pb-60 sm:pt-10 md:pb-20 sm:pb-20 md:pt-32 md:-mt-16">
      {/* Objetivos */}
      <div className="flex md:flex-row sm:flex-col justify-center items-center w-full ">
        ...
        <div className=" flex flex-col justify-around items-center md:w-[670px] sm:w-[360px] py-20 md:-mt-[210px] ">
          ...
          <div
            className={`hexagono1 md:w-[668px] sm:w-[360px] md:h-[528px] sm:h-[300px] justify-center items-center sm:z-30
        ...
        <div className="flex md:flex-col sm:flex-col justify-center items-center md:w-[670px] sm:w-[360px] md:-mt-16 sm:-mt-32">
          <div
            className={`hexagono3 md:w-[668px] sm:w-[360px] md:h-[528px] sm:h-[300px] justify-center items-center md:mb-12
          ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}
          >
