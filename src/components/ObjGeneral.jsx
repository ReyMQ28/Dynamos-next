...
function ObjGeneral() {
  ...
  return (
    // principal
    <div className="md:w-full md:h-full flex flex-col justify-center imagen-about lg:pt-6 lg:pb-60  md:pb-28 md:pt-20">
      {/* Objetivos */}
      <div className="flex md:flex-row sm:flex-col justify-center items-center w-auto ">
        ...
        <div className=" flex flex-col justify-between items-center md:w-[670px] sm:w-auto md:py-20 md:-mt-32 md:-ml- ">
          <div
            className={`trapecio md:hidden sm:-mr-0 md:-mr-[80px] md:w-[556px] sm:w-[200px] md:h-[150px] sm:h-24 md:-mt-10 md:ml-9 sm:ml-40 md:mb-7 sm:mb- sm:z-30
        ...
        <div className="flex flex-col justify-around items-center md:w-[670px] sm:w-[360px] sm:-mr-">
          <div
            className={`trapecio md:flex sm:hidden sm:-mr-0 md:-mr-[80px] md:w-[556px] sm:w-[250px] md:h-[150px] sm:h-28 md:-mt-7 sm:-mt- md:ml-9 sm:ml-28 md:mb-7 
            ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}
          ></div>
          <div
            className={`hexagono3  md:w-[668px] sm:w-[360px] md:h-[528px] sm:h-[300px] justify-center items-center md:mb-52 sm:mb-24 
            ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}
          >
          ...
          <div
            className={`md:justify-center md:items-center text-transparent trapecio2 md:-mr-[80px] md:w-[556px] sm:w-[200px] md:h-[150px] sm:h-24 md:ml-9 sm:ml-40 
            ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}
          >
            <p className="md:justify-center md:items-center text-black dark:text-white lg:text-xl md:text-2xl italic font-semibold md:ml-32 sm:ml-4 md:mt-3 sm:mt-2 ">
              @Dynamos_movimiento
            </p>
          </div>
        </div>
