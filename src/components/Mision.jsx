...
function Mision() {
  ...
  return (
    <div className={`flex flex-row justify-center items-center lg:mt-12 md:mt-0 sm:mt-0 w-full h-full imagen-about sm:mb-20
      ${
      darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"
    }`}>
      {/* Mision */}
      <div className="flex flex-col justify-center items-center h-auto lg:w-[600px] lg:pb-60 lg:pt-20 lg:mb-20 md:w-[600px] md:pb-60 md:pt-20 md:mb-20 sm:w-[600px] sm:pb-10 sm:pt-20 sm:mb-20">
        {/* circulo */}
        <div
        ...
        <div className="lg:w-96 lg:-mt-96 lg:mr-24 md:w-96 md:-mt-96 md:mr-24 sm:w-48 sm:-mt-7 sm:mr-">
          <h1
            className={`dark:text-gray-300 italic font-extrabold lg:text-[68px] lg:mb-16 lg:ml-10 md:text-[68px] md:mb-16 md:ml-10 sm:text-3xl sm:mb-3 sm:ml-0 ${
              darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"
            }`}
          >
            MISIÓN
          ...
          <p
            className={`text-justify dark:text-gray-300 text-gray-900 font-bold lg:text-base lg:mb-12 lg:w-80 lg:-ml-2 md:text-base md:mb-12 md:w-80 md:-ml-2 sm:text-[11px] sm:mb-6 sm:w-44 sm:-ml-8 sm:font-extrabold-bold ${
              darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"
            }`}
          >
          ...
          <p
            className={`dark:text-gray-300 italic lg:text-sm md:text-sm sm:text-xs font-semibold lg:ml-8 md:ml-8 sm:ml-2 ${
              darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"
            }`}
          >
            @Dynamos_movimiento
