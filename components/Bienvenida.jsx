...
import imagenPrincipal from "../img/main/imagen-principal.jpg";
...
function Bienvenida() {
  ...
  return (
    <div
      className={`flex w-full justify-center items-center lg:pt-40 md:pt-30 sm:pt-12 ${
    ...
    >
      <div className="w-10/12 flex md:flex-row md:pb-24 sm:flex-col sm:justify-center sm:items-center">
        <div className="flex flex-col md:w-11/12 md:text-left md:m-10 md:mt-32 sm:mt-12">
          <h2 className={`md:text-6xl md:text-left font-bold md:mb-10 sm:text-2xl sm:text-center sm:mb-10 text-white sm:text-black dark:sm:text-white ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}>
