...
function Footer() {
  ...
  return (
    ...
    >
      ...
      <p className={`select-none md:w-full md:text-base sm:text-xs text-center dark:text-gray-400 text-black ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}>
